...
/**
 * Implementation of TableCellRenderer. <br>
 * Alone method returns renderer for boolean if <tt>value</tt> is not-null
...
public class BooleanCellRenderer extends DefaultTableCellRenderer {
	...
	/**
	 * Returns the table cell renderer. If <tt>value</tt> is not-null instance
	 * of Boolean class, returns renderer for boolean. Else returns default
	 * table cell renderer
	 * 
	 * @param table
